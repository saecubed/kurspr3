...
<body class="bg-info p-2 text-dark bg-opacity-10">
    <div class="container-fluid">   
        <nav class="fixed-top navbar navbar-expand-lg navbar-light" style="background-color:#13085b">        
            <div class="container-fluid">                
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav text-light">
                        ...
                        <li class="nav-item">
                        <a class="nav-link text-light" href="statistics.php">Статистика по районам</a>
                        </li>
                    </ul>
                </div>
            </div>
